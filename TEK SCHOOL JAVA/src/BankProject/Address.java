...
public class Address {
		...
		// we need one parameterized consturctor that will take all of the address infor and design it to the variables in the obj
		...
		//this is the toString method - the definition of this class to the method should match this exactly		
